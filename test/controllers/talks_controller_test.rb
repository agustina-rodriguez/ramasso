...
class TalksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create talk" do
    assert_difference('Talk.count') do
      post talks_url, params: { talk: { event_id: @talk.event_id, name: @talk.name, schedule: @talk.schedule } }
    end
  ...
  test "should update talk" do
    patch talk_url(@talk), params: { talk: { event_id: @talk.event_id, name: @talk.name, schedule: @talk.schedule } }
